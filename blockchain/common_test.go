...
// bglutil.Block.  This is largely borrowed from the test code in btcdb.
func loadBlocks(filename string) (blocks []*bglutil.Block, err error) {
	...
	for height := int64(1); err == nil; height++ {
		...
		block, err = bglutil.NewBlockFromBytes(rbytes)
		if err != nil {
			return
		}
