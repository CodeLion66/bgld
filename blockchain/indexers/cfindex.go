...
func storeFilter(dbTx database.Tx, block *bglutil.Block, f *gcs.Filter,
...
func (idx *CfIndex) ConnectBlock(dbTx database.Tx, block *bglutil.Block,
...
func (idx *CfIndex) DisconnectBlock(dbTx database.Tx, block *bglutil.Block,
