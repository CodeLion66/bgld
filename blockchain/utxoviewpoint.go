...
func (view *UtxoViewpoint) AddTxOut(tx *bglutil.Tx, txOutIdx uint32, blockHeight int32) {
...
func (view *UtxoViewpoint) AddTxOuts(tx *bglutil.Tx, blockHeight int32) {
...
func (view *UtxoViewpoint) connectTransaction(tx *bglutil.Tx, blockHeight int32, stxos *[]SpentTxOut) error {
...
func (view *UtxoViewpoint) connectTransactions(block *bglutil.Block, stxos *[]SpentTxOut) error {
...
func (view *UtxoViewpoint) disconnectTransactions(db database.DB, block *bglutil.Block, stxos []SpentTxOut) error {
...
// not modified.
func (view *UtxoViewpoint) fetchInputUtxos(db database.DB, block *bglutil.Block) error {
...
func (b *BlockChain) FetchUtxoView(tx *bglutil.Tx) (*UtxoViewpoint, error) {
