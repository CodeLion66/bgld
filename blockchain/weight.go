...
func GetBlockWeight(blk *bglutil.Block) int64 {
...
func GetTransactionWeight(tx *bglutil.Tx) int64 {
	msgTx := tx.MsgTx()
...
func GetSigOpCost(tx *bglutil.Tx, isCoinBaseTx bool, utxoView *UtxoViewpoint, bip16, segWit bool) (int, error) {
