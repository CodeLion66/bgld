...
var (
	defaultHomeDir     = bglutil.AppDataDir("btcd", false)
...
func loadConfig() (*config, []string, error) {
	...
	cfg.minRelayTxFee, err = bglutil.NewAmount(cfg.MinRelayTxFee)
	if err != nil {
	...
	cfg.miningAddrs = make([]bglutil.Address, 0, len(cfg.MiningAddrs))
	for _, strAddr := range cfg.MiningAddrs {
		addr, err := bglutil.DecodeAddress(strAddr, activeNetParams.Params)
		if err != nil {
