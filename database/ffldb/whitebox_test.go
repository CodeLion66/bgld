...
// a slice of them.
func loadBlocks(t *testing.T, dataFile string, network wire.BitcoinNet) ([]*bglutil.Block, error) {
	...
	blocks := make([]*bglutil.Block, 0, 256)
	genesis := bglutil.NewBlock(chaincfg.MainNetParams.GenesisBlock)
