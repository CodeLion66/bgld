...
func createCoinbaseTx(coinbaseScript []byte, nextBlockHeight int32,
	addr bglutil.Address, mineTo []wire.TxOut,
	net *chaincfg.Params) (*bglutil.Tx, error) {
...
func CreateBlock(prevBlock *bglutil.Block, inclusionTxs []*bglutil.Tx,
	blockVersion int32, blockTime time.Time, miningAddr bglutil.Address,
	mineTo []wire.TxOut, net *chaincfg.Params) (*bglutil.Block, error) {
	...
	blockTxns := []*bglutil.Tx{coinbaseTx}
	if inclusionTxs != nil {
	...
	utilBlock := bglutil.NewBlock(&block)
