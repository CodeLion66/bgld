...
func New(activeNet *chaincfg.Params, handlers *rpcclient.NotificationHandlers,
	...
	if handlers.OnFilteredBlockConnected != nil {
		...
		handlers.OnFilteredBlockConnected = func(height int32, header *wire.BlockHeader, filteredTxns []*bglutil.Tx) {
...
func (h *Harness) SetUp(createTestChain bool, numMatureOutputs uint32) error {
	...
	// wallet.
	filterAddrs := []bglutil.Address{h.wallet.coinbaseAddr}
...
func (h *Harness) NewAddress() (bglutil.Address, error) {
...
//
// This function is safe for concurrent access.
func (h *Harness) ConfirmedBalance() bglutil.Amount {
...
//
// This function is safe for concurrent access.
func (h *Harness) GenerateAndSubmitBlock(txns []*bglutil.Tx, blockVersion int32,
	blockTime time.Time) (*bglutil.Block, error) {
...
func (h *Harness) GenerateAndSubmitBlockWithCustomCoinbaseOutputs(
	txns []*bglutil.Tx, blockVersion int32, blockTime time.Time,
	mineTo []wire.TxOut) (*bglutil.Block, error) {
	...
	prevBlock := bglutil.NewBlock(mBlock)
