...
import (
	...
	"github.com/bitgesellofficial/bgld/addrmgr"
	...
	"github.com/bitgesellofficial/bgld/connmgr"
	...
	"github.com/bitgesellofficial/bgld/mining/cpuminer"
...
func (sp *serverPeer) OnTx(_ *peer.Peer, msg *wire.MsgTx) {
	...
	// Convert the raw MsgTx to a bglutil.Tx which provides some convenience
	// methods and things such as hash caching.
	tx := bglutil.NewTx(msg)
...
func (sp *serverPeer) OnBlock(_ *peer.Peer, msg *wire.MsgBlock, buf []byte) {
	// Convert the raw MsgBlock to a bglutil.Block which provides some
	// convenience methods and things such as hash caching.
	block := bglutil.NewBlockFromBlockAndBytes(msg, buf)
...
func (sp *serverPeer) OnFeeFilter(_ *peer.Peer, msg *wire.MsgFeeFilter) {
	...
	if msg.MinFee < 0 || msg.MinFee > bglutil.MaxSatoshi {
		peerLog.Debugf("Peer %v sent an invalid feefilter '%v' -- "+
			"disconnecting", sp, bglutil.Amount(msg.MinFee))
		sp.Disconnect()
		return
	}
...
func (s *server) TransactionConfirmed(tx *bglutil.Tx) {
...
func newServer(listenAddrs, agentBlacklist, agentWhitelist []string,
	...
	txC := mempool.Config{
		...
		CalcSequenceLock: func(tx *bglutil.Tx, view *blockchain.UtxoViewpoint) (*blockchain.SequenceLock, error) {
